/**
 * Install Local MongoDB Helper
 * This script helps you install MongoDB locally
 */

console.log('💾 Install Local MongoDB for FarmConnect');
console.log('========================================\n');

console.log('📥 Download MongoDB Community Server:\n');

console.log('1️⃣ Download MongoDB:');
